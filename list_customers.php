...
<fieldset>
	...
	<div id="list_filter">
		<span class="filter_link selected_filter"><a href="#" onclick="ajax( null, 'customer_list_section', 'innerHTML', 'Customer::showList', <?php
		echo "'criteria=$criteria'" ?>, null, null ); showFilterIndicator(this)">All</a></span><span class="filter_separator">|</span><span
		class="filter_link"><a href="#" onclick="ajax( null, 'customer_list_section', 'innerHTML', 'Customer::showList', <?php
		...
		foreach (range('A', 'Z') as $i) {
			echo '<span class="filter_separator">|</span><span class="filter_link"><a href="#" onclick="' .
				 "ajax(null, 'customer_list_section', 'innerHTML', 'Customer::showList', 'criteria=$criteria', 'filterName=alpha', 'filterValue=$i');" .
