...
?>	<fieldset><legend><?php
		...
		?></legend>
		<div id="list_filter">
		<span class="filter_link selected_filter"><a href="#" onclick="ajax( null, 'supplier_list_section', 'innerHTML', 'Supplier::showList', <?php echo "'criteria=" . $criteria . "'" ?>, null, null ); showFilterIndicator(this)">All</a></span><span class="filter_separator">|</span><span class="filter_link"><a href="#" onclick="ajax( null, 'supplier_list_section', 'innerHTML', 'Supplier::showList', <?php echo "'criteria=" . $criteria . "'" ?>, 'filterName=alpha', 'filterValue=#' ); showFilterIndicator(this)">#</a></span><?php
		foreach ( range('A','Z') as $i ) {
			echo '<span class="filter_separator">|</span><span class="filter_link"><a href="#" onclick="ajax( null, \'supplier_list_section\', \'innerHTML\', \'Supplier::showList\', \'criteria=' . $criteria . '\', \'filterName=alpha\', \'filterValue=' . $i . '\' ); showFilterIndicator(this)">' . $i . '</a></span>';
		}
		?>
        </div>
